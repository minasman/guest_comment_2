stores_list = {
    "1480" => {"name" => "South Laredo", "store_number" => "1480", "store_email" => "hou.01480@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "6", "gm_id" => "11"},
    "1703" => {"name" => "SW Military", "store_number" => "1703", "store_email" => "hou.01703@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "4", "gm_id" => "12"},
    "1725" => {"name" => "San Pedro", "store_number" => "1725", "store_email" => "hou.01725@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "9", "gm_id" => "13"},
    "2962" => {"name" => "West Commerce", "store_number" => "2962", "store_email" => "hou.02962@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "8", "gm_id" => "14"},
    "3348" => {"name" => "Southcross", "store_number" => "3348", "store_email" => "hou.03348@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "9", "gm_id" => "15"},
    "3447" => {"name" => "Wurzbach", "store_number" => "3447", "store_email" => "hou.03447@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "6", "gm_id" => "16"},
    "5166" => {"name" => "WW White", "store_number" => "5166", "store_email" => "hou.05166@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "7", "gm_id" => "17"},
    "5623" => {"name" => "Roosevelt", "store_number" => "5623", "store_email" => "hou.05623@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "4", "gm_id" => "18"},
    "6661" => {"name" => "Hill Country", "store_number" => "6661", "store_email" => "hou.06661@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "5", "gm_id" => "19"},
    "7091" => {"name" => "West Houston", "store_number" => "7091", "store_email" => "hou.07091@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "6", "gm_id" => "20"},
    "7850" => {"name" => "Med Center", "store_number" => "7850", "store_email" => "hou.07850@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "7", "gm_id" => "21"},
    "10586" => {"name" => "Vance Jackson", "store_number" => "10586", "store_email" => "hou.10586@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "9", "gm_id" => "22"},
    "10675" => {"name" => "Guilbeau", "store_number" => "10675", "store_email" => "hou.10675@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "8", "gm_id" => "23"},
    "12673" => {"name" => "DeZavala", "store_number" => "12673", "store_email" => "hou.12673@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "6", "gm_id" => "24"},
    "13364" => {"name" => "Zarzamora", "store_number" => "13364", "store_email" => "hou.13364@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "7", "gm_id" => "25"},
    "14073" => {"name" => "Broadway", "store_number" => "14073", "store_email" => "hou.14073@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "5", "gm_id" => "26"},
    "16166" => {"name" => "WM 1604", "store_number" => "16166", "store_email" => "hou.16166@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "8", "gm_id" => "27"},
    "17018" => {"name" => "WM Jones Maltzburger", "store_number" => "17018", "store_email" => "hou.17018@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "5", "gm_id" => "28"},
    "17726" => {"name" => "Rigsby", "store_number" => "17726", "store_email" => "hou.17726@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "6", "gm_id" => "29"},
    "19116" => {"name" => "Babcock & Prue", "store_number" => "19116", "store_email" => "hou.19116@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "9", "gm_id" => "30"},
    "22796" => {"name" => "O'Conner", "store_number" => "22796", "store_email" => "hou.22796@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "5", "gm_id" => "31"},
    "23005" => {"name" => "Floresville", "store_number" => "23005", "store_email" => "hou.23005@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "4", "gm_id" => "32"},
    "24388" => {"name" => "Converse", "store_number" => "24388", "store_email" => "hou.24388@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "7", "gm_id" => "33"},
    "26150" => {"name" => "Stonecroft", "store_number" => "26150", "store_email" => "hou.26150@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "10", "gm_id" => "34"},
    "28465" => {"name" => "WM Boerne", "store_number" => "28465", "store_email" => "hou.28465@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "10", "gm_id" => "35"},
    "28626" => {"name" => "WM DeZavala", "store_number" => "28626", "store_email" => "hou.28626@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "9", "gm_id" => "36"},
    "28632" => {"name" => "WM Rigsby", "store_number" => "28632", "store_email" => "hou.28632@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "8", "gm_id" => "37"},
    "28656" => {"name" => "Ralph Fair", "store_number" => "28656", "store_email" => "hou.28656@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "10", "gm_id" => "38"},
    "29841" => {"name" => "WM Converse", "store_number" => "29841", "store_email" => "hou.29841@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "7", "gm_id" => "39"},
    "29844" => {"name" => "WM Vance Jackson", "store_number" => "29844", "store_email" => "hou.29844@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "6", "gm_id" => "40"},
    "30378" => {"name" => "WM SW Military", "store_number" => "30378", "store_email" => "hou.30378@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "4", "gm_id" => "41"},
    "31089" => {"name" => "WM Schertz", "store_number" => "31089", "store_email" => "hou.31089@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "5", "gm_id" => "42"},
    "32872" => {"name" => "Somerset", "store_number" => "32872", "store_email" => "hou.32872@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "", "supervisor_id" => "4", "gm_id" => "43"},
    "34798" => {"name" => "The Rim", "store_number" => "34798", "store_email" => "hou.34798@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "10", "gm_id" => "44"},
    "35416" => {"name" => "Comfort", "store_number" => "35416", "store_email" => "hou.35416@us.stores.mcd.com", "owner_id" => "1", "director_id" => "2", "om_id" => "3", "supervisor_id" => "10", "gm_id" => "45"}
